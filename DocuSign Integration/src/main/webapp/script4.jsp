...
position: absolute;
  ...
  width:100px;
   ...
   <form method="post" action="create">
    <h1> Create Files in Different Formats</h1>

  
    <div class="container">
        <div class="box box-1">
            <div class="cover"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/945546/3433202-893bc9989a52eba0.png" alt=""></div>
            <a href="http://localhost/example/editor?fileExt=xlsx" onclick="setCookiexlsx()"> 
...
<script>
function setCookiexlsx() {
  // Set the cookie with a name "myCookie" and a value "cookieValue"
  document.cookie = "myCookie=xlsx";
}
function setCookiedocx() {
	  // Set the cookie with a name "myCookie" and a value "cookieValue"
	  document.cookie = "myCookie=docx";
	}
function setCookiedocxf() {
	  // Set the cookie with a name "myCookie" and a value "cookieValue"
	  document.cookie = "myCookie=docxf";
	}
function setCookiepptx() {
	  // Set the cookie with a name "myCookie" and a value "cookieValue"
	  document.cookie = "myCookie=pptx";
	}
</script>
   </body>
   </html>
